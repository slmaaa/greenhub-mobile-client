...
export const Home = ({ setCurrentPage, user, currentPage }) => {
  ...
  return html`
    <div class="hero is-flex is-flex-direction-column full-height">
      <div
        class="px-5 py-5 is-flex-grow-1 is-flex is-flex-direction-column is-justify-content-start"
      >
        <div class="header">
          <h1
            class="title is-4 has-text-primary is-primary has-text-weight-bold"
          >
            Welcome to Greenhub
          </h1>
          ...
          >
            ...
            >
            <button
              class="button is-right is-align-self is-warning is-rounded is-size-6 is-small"
            >
              Top up
            </button>
          </div>
